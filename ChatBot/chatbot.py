...
root = tk.Tk()
root.title("Chatbot - Yellow Theme")

# Set the window size and background color
root.geometry("400x475")
root.config(bg='#FFF9C4')  # Light yellow background
...
chat_window.tag_configure("user_tag", foreground="black", background="#FFD54F",  # Golden yellow
                          justify="left", font=("Helvetica", 12, "bold"), relief=tk.RAISED, 
                          lmargin1=10, lmargin2=10, rmargin=10)

chat_window.tag_configure("bot_tag", foreground="black", background="#FFEB3B",  # Bright yellow
                          justify="right", font=("Helvetica", 12, "italic"), relief=tk.RAISED, 
                          lmargin1=10, lmargin2=10, rmargin=10)

# Create a text entry box for typing user input
input_frame = tk.Frame(root, bg='#FFF9C4')  # Light yellow background
...
send_button = tk.Button(input_frame, text="Send", command=send_message, font=("Helvetica", 12), 
                        bg="#FFD54F", fg="black", width=8)  # Golden yellow button
